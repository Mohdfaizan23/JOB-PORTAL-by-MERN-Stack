...
export const postApplication = catchAsyncErrors(async (req, res, next) => {
  ...
  // Handle resume upload with multer (file is stored in req.file)
  if (req.file) {
    // Multer has already uploaded the file to Cloudinary, and the file info is available in req.file
    jobSeekerInfo.resume = {
      public_id: req.file.filename, // Public ID generated by multer storage
      url: req.file.path, // URL of the uploaded file
    };
  } else {
    // If no new resume is uploaded, check if the user has an existing resume
